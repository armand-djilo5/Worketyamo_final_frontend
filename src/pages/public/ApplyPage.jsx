      ...
      >
        ...
        <Section title="Vos coordonnées">
          ...
          <Field label="Numéro de téléphone" required error={fieldErrors.phone}>
            <div
              className={`flex overflow-hidden rounded-xl border bg-cream-50 focus-within:border-forest-400 ${
                fieldErrors.phone ? "border-red-300" : "border-ink-900/10"
              }`}
            >
...
function inputClass(hasError) {
  return `w-full rounded-xl border bg-cream-50 px-3.5 py-2.5 text-sm text-ink-900 placeholder:text-ink-300 focus:outline-none focus:border-forest-400 transition-smooth ${
    hasError ? "border-red-300" : "border-ink-900/10"
  }`;
}
