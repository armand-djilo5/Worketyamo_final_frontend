...
export default function RequestsPage() {
    ...
    return (
        <>
            <AdminTopbar title="Candidatures" onMenuClick={openDrawer} />
                                        ...
                                        <tbody>
                                            {requests.map((r) => (
                                                <tr
                                                    ...
                                                    className={`cursor-pointer border-b border-ink-900/5 last:border-0 transition-smooth ${selectedId === r.id ? "bg-forest-50/70" : "hover:bg-cream-50/60"
                                                        }`}
                                                >
